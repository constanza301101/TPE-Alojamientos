...
function getComments() {
    let id_habitacion = document.querySelector('#input_IdHabitacion').value;
    fetch('api/habitacion/' + id_habitacion + '/comments')
...
function addComment(){
    ...
    if(validacion == true){
        ...
        const comment = {
            ...
            id_habitacion: document.querySelector('#input_IdHabitacion').value
        }
